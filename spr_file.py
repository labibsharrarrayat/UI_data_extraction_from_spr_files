...
def main_process(filing):
    ...
    writer = pd.ExcelWriter(excel_report, engine='xlsxwriter')
    ...
    if (fail_part.empty != True):
        ...
        colors = (
            'tab:olive', 'tab:red', 'tab:cyan', 'forestgreen', 'tab:pink', 'tab:gray', 'tab:purple', 'tab:orange',
            'navy',
